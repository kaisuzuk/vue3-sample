...
3. マスタストア実装
4. MSW セットアップ
5. マスタ fixture / handler 作成

### Phase 2: 一覧画面

1. TaskListPage 実装
2. TaskListWidget 実装
3. TaskTableSection 実装
4. タスク一覧 fixture / handler 作成
5. ページネーション実装

### Phase 3: 詳細サイドバー

1. TaskDetailSidebar 実装
2. TaskDetailSection 実装
3. タスク詳細 fixture / handler 作成
4. 削除機能実装
5. ConfirmDialog 実装
...
1. TaskCreatePage 実装
2. TaskFormWidget 実装
3. TaskFormSection 実装
4. MaterialListSection 実装
5. MaterialAmountDialog 実装
6. タスク登録 fixture / handler 作成

### Phase 5: 編集画面

1. TaskEditPage 実装
2. TaskFormWidget の編集モード対応
3. タスク更新 fixture / handler 作成
...
各コンポーネントには Storybook の Story ファイルを作成します。
...
│   │       └── TaskListWidget/
│   │           ├── TaskListWidget.vue
│   │           ├── TaskListWidget.stories.ts  # ← Story
│   │           └── index.ts
```
